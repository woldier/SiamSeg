...
#PORT=${PORT:-10985}
CONFIG_FILE=${CONFIG_FILE:-$(dirname $0)/../default_config.yaml}
...
python -m accelerate.commands.launch --config_file $CONFIG_FILE \
    $(dirname "$0")/train_accelerate.py  $CONFIG  ${@:2}
